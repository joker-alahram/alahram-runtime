...
export async function renderPortalInvoice(container, params) {
  const orderId = params?.invoiceId || '';
  if (!orderId) {
    container.innerHTML = '<div class="v2-error"><p>الفاتورة غير موجودة</p><a href="#portal/orders" class="v2-btn v2-btn-p">عودة للطلبات</a></div>';
    return;
  }
  location.hash = '#portal/orders/' + orderId;
}
